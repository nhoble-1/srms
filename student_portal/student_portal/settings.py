...
DEFAULT_FROM_EMAIL  = os.environ.get('DEFAULT_FROM_EMAIL', 'Portal <noreply@uniqueopenuniversity.edu.ng>')

# Fallback to console backend if no SMTP credentials are set (useful for dev)
